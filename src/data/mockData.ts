...
export const stops: Stop[] = [
    ...
    { id: 'wapping-wharf', name: 'Wapping Wharf', coords: { lat: 51.4474728, lon: -2.6008459 }, landCoords: { lat: 51.447470, lon: -2.601550 } }, // Matches node 12951701026 for the water path
